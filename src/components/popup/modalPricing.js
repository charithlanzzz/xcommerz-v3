...
function ModalPricing(props) {
    const { show, closeModal, selectedPlanTitle: planTitle } = props;
    ...
    const [selectedPlanTitle, setSelectedPlanTitle] = useState(planTitle);
                ...
                <div id="myModal" className="modal" style={show?displayBlock:displayNone}>
                    ...
                    <div className="modal-content d-flex align-items-center text-center">
                        <div className="outer-container">
                            ...
                            {/* Contact Form */}
                            <form id="pricing-form" className="custom-form" method="POST" action="assets/php/pricingmail.php">
                                <div className="row">
                                    <div className="col">
                                        ...
                                        <div className="col-sm-8">
                                        <select id="inputPackage" name="package" className="form-control" required="required" value={selectedPlanTitle} onChange={(e) => setSelectedPlanTitle(e.target.value)}>
