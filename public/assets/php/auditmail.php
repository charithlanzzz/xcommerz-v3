<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($email) OR empty($phone) OR empty($website) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $subject = "xCommerz - Request an Audit - ".date("Y-m-d H:i:s");
