  ...
  return (
    <>
       ...
       <div className="quote-form-pop anim">
                <div id="auditModal" className="modal" style={show?displayBlock:displayNone}>
                    {/* <!-- Modal content --> */}
                    <div className="modal-content d-flex align-items-center text-center">
                        <div className="outer-container">
                            <span className="close" onClick={closeModal}>&times;</span>
                            <div className="request-text"><strong>Get a Free Audit</strong></div>
                            <div className="contact-box text-center">
                            {/* Contact Form */}
                            <form id="audit-form" className="custom-form" method="POST" action="assets/php/auditmail.php">
                                <div className="row">
                                    <div className="col">
                          ...
                          <select name="countrycode" className="form-control w-50">
                            ...
                            <input type="text" className="form-control" name="phone" placeholder="Phone" required="required"/>
                                        ...
                                        <div className="form-group row">
                                        <label for="inputWebsite" className="col-sm-4 col-form-label">Your Website<sup>*</sup></label>
                                        <div className="col-sm-8">
                                        <input type="text" className="form-control" name="website" placeholder="Your Website" required="required" />
                                        </div>
                                        </div>                                      
                                        <div className="form-group row">                                        
