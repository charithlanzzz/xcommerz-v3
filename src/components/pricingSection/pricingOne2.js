                            ...
                            {this.state.priceData.map((item, idx) => {
                                return(
                                    <div key={`pd_${idx}`} className={item.planClass}>
                                        ...
                                        <button onClick={this.openModal} className="btn btn-bordered text-uppercase">
                                            <span>{item.btnText}</span>
                                        </button>
                                    
                                        <ModalPricing closeModal={this.closeModal} show={this.state.showModal} selectedPlanTitle={this.state.selectedPlanTitle} />
                            ...
                            {this.state.priceDatamobile.map((item, idx) => {
                                return(
                                    <div key={`pd_${idx}`} className={item.planClass}>
                                        ...
                                        <button onClick={() => this.openModal(item.planTitle)} className="btn btn-bordered text-uppercase">
    <span>{item.btnText}</span>
</button>
                                    
                                    <ModalPricing closeModal={this.closeModal} show={this.state.showModal} />
